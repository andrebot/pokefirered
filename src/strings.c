...
const u8 gText_DexLearnset[] = _("LEARNSET");
const u8 gText_DexTmHm[] = _("TM/HM");
const u8 gText_NextDataPreviousData[] = _("{A_BUTTON}NEXT DATA {B_BUTTON}PREVIOUS DATA");
const u8 gText_TM[] = _("TM");
const u8 gText_HM[] = _("HM");
const u8 gText_DexEvolution[] = _("EVOLUTION");
const u8 gText_DexNoEvolutions[] = _("Does not evolve");
const u8 gText_EvoUseItem[] = _("Use ");
const u8 gText_EvoTradeHolding[] = _("Trade holding ");
const u8 gText_EvoFriendship[] = _("Friendship");
const u8 gText_EvoTrade[] = _("Trade");
const u8 gText_EvoBeauty[] = _("Beauty ");
...
const u8 gText_PokeSum_Controls_PageEVs[] = _("{DPAD_LEFT}PAGE {A_BUTTON}EVs");
const u8 gText_PokeSum_Controls_PageStats[] = _("{DPAD_LEFT}PAGE {A_BUTTON}STATS");
const u8 gText_PokeSum_IVLabel[] = _("IV");
const u8 gText_PokeSum_EVLabel[] = _("EV");
